...
//
// Disclaimer:
// The OilXCoin is issued as a ledger-based security. The terms are available under the
// following link: https://oilxcoin.io/terms
//
...
/**
 * @title OilXCoinProxy
 * @notice The OilXCoin is issued as a ledger-based security. The terms are available under the
 * following link: https://oilxcoin.io/terms
 * @dev This contract implements an upgradeable proxy. It is upgradeable because calls are delegated
 * to an implementation address that can be changed. This address is stored in storage in the
 * location specified by https://eips.ethereum.org/EIPS/eip-1967[EIP1967], so that it doesn't
 * conflict with the storage layout of the implementation behind the proxy.
 */
contract OilXCoinProxy is Proxy {
  /**
