    ...
    function generateTexts(
        ...
        description = string(
            abi.encodePacked( description,
                ...
                " are correct. More information can be found under https://oilxcoin.io/. DeXentra GmbH does not assume any liability for imitations or errors made in",
    ...
    function getMetaAttributes(
        ...
        strAttributes = string(
            abi.encodePacked(
                ...
                ",",
                addMetadataAttributeDisplayType("Claimed", strOilXamountClaimedText, "boost_number"),
                ",",
